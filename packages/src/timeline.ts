...
export class Timeline extends LitElement {
  ...
  render() {
    ...
    const sizeClass = `font-size-${this.fontSize}`;
    const wrapperClass = `timeline-wrapper ${sizeClass}${this.isDark ? ' dark' : ''}`;

    return html`
      <div class="${wrapperClass}">
        ${this.title ? html`
          <div class="timeline-header">
            <h2 class="timeline-header-title">${this.title}</h2>
          </div>
        ` : ''}
            ...
            <div class="timeline-item ${item.image ? 'has-image' : ''} ${sideClass}">
              ...
              <div class="timeline-content">
                ...
                <div class="timeline-content-inner">
                  ...
                  ${item.content ? html`<div class="timeline-description">${item.content}</div>` : ''}
