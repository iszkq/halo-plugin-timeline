...
export const timelineStyles = css`
  ...
  /* 文字大小：small / medium / large */
  .timeline-wrapper.font-size-small {
    --timeline-base-size: 12px;
    --timeline-title-size: 14px;
    --timeline-date-size: 11px;
    --timeline-desc-size: 12px;
    --timeline-header-size: 18px;
  }

  .timeline-wrapper.font-size-medium {
    --timeline-base-size: 14px;
    --timeline-title-size: 16px;
    --timeline-date-size: 12px;
    --timeline-desc-size: 13px;
    --timeline-header-size: 20px;
  }

  .timeline-wrapper.font-size-large {
    --timeline-base-size: 18px;
    --timeline-title-size: 22px;
    --timeline-date-size: 15px;
    --timeline-desc-size: 16px;
    --timeline-header-size: 26px;
  }

  .timeline-wrapper {
    font-size: var(--timeline-base-size, 14px);
  }
  ...
  .timeline-header-title {
    font-size: var(--timeline-header-size, 18px);
    font-weight: 600;
    color: var(--timeline-text-color);
    margin: 0;
  }
  ...
  .timeline-date {
    font-size: var(--timeline-date-size, 12px);
  ...
  .timeline-title {
    font-size: var(--timeline-title-size, 15px);
    font-weight: 500;
  ...
  .timeline-description {
    font-size: var(--timeline-desc-size, 13px);
    color: var(--timeline-date-color);
    line-height: 1.6;
    margin: 0 0 6px 0;
  ...
  :host .timeline-wrapper.dark .timeline-header-title {
    color: var(--timeline-text-color-dark);
  }

  :host .timeline-wrapper.dark .timeline-description {
    color: var(--timeline-date-color-dark);
  }
